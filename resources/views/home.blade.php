                            ...
                            <table class="table table-striped table-hover table-responsive" style="font-size: 12px;">
                                ...
                                @foreach($candidatos as $candidato)
                                    <tr>
                                        ...
                                        <td>{{$candidato->ingles}}</td>
                                        <td>{{$candidato->telefone}}</td>
                                        <td>{{$candidato->resumo}}</td>
                                        <td>{{$candidato->linkedin}}</td>
                                        <td>{{$candidato->github}}</td>
                                        <td>R${{$candidato->salario}}</td>
                                        <td><a href="{{url('download', $candidato->file)}}" class="btn  btn-link"><i class="fas fa-download"></i></a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
